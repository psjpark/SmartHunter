...
namespace SmartHunter.Game.Data.ViewModels
{
    public class SettingsViewModel : Bindable
    {
        ...
        public SettingsViewModel()
        {
            ...
            Settings.Add(new Setting(ConfigHelper.Main.Values.Overlay.MonsterWidget.IsVisible, "System", " ", new Command(_ =>
            {               
            }), "Bold","Hidden"));

            Settings.Add(new Setting(ConfigHelper.Main.Values.ShutdownWhenProcessExits, " ", " ", new Command(_ =>
            {
