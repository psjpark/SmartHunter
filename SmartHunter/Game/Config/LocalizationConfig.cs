...
namespace SmartHunter.Config
{
    public class LocalizationConfig
    {
        ...
        public Dictionary<string, string> Strings = new Dictionary<string, string>()
        {
            ...
            { "LOC_SETTING_HIDE_WHEN_GAME_WINDOW_IS_INACTIVE_DESC", "Automatically hide every SmartHunter window when MonsterHunterWorld it not the top most application"},
            { "LOC_SETTING_DEBUG_WIDGET", "Enable debugging"},
            { "LOC_SETTING_DEBUG_WIDGET_DESC", "Show/Hide Debug Widget"},
            ...
            { "LOC_SETTING_ALWAYS_SHOW_PARTS", "    Show broken parts"},
            { "LOC_SETTING_ALWAYS_SHOW_PARTS_DESC", "Show damanged monster parts"},
            ...
            { "LOC_SETTING_SHOW_STATUS_EFFECTS", "    Show status effects" },
            { "LOC_SETTING_SHOW_STATUS_EFFECTS_DESC", "Show status effects" },
            { "LOC_SETTING_SHOW_MONSTER_SIZE", "    Show monster size"},
            { "LOC_SETTING_SHOW_MONSTER_SIZE_DESC", "Show monster size when you hover your mouse curser over its name"},
